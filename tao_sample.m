...
%     scatter3(xx(i,:),Sw(i,:),Sdb(i,:),sign{i},'SizeData',8^2);
%     hold on
% end
...
for i=1:length(a)-1 %for each interval
    ...
    text(135,1.6,'\leftarrow c1')

xlabel('step sequence','FontSize',12)
ylabel('web server demand ','FontSize',12)
